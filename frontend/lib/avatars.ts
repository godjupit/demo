...
export const speakerAvatars: Record<string, SpeakerAvatar> = {
  ...
  arch: { initials: "AR", mark: "TEXTILE", colors: ["#3f7f74", "#c9d8a3"] },
  ...
  zhao_yiren: { initials: "赵", mark: "CARE", colors: ["#28745e", "#b9d8c2"] },
  xiaohei: { initials: "黑", mark: "MONSTER", colors: ["#232323", "#c5d86d"] },
  zhu_jingming: { initials: "朱", mark: "VOICE", colors: ["#7b4368", "#f0a7a0"] },
  fang_chenchu: { initials: "晨", mark: "BOOK", colors: ["#386f77", "#f1d18a"] },
  liao_zhili: { initials: "廖", mark: "HOME", colors: ["#536b4e", "#d4c49c"] },
  ...
  spring_changzhou: { initials: "春", mark: "AI", colors: ["#2f7d8c", "#c8e36f"] },
